...
{
    internal class RackHorizontalWood2x3Block : Block
    {
        ...
        public override void OnLoaded(ICoreAPI api)
        {
            ...
            interactions = ObjectCacheUtil.GetOrCreate(api, "rackhorizontalwood2x3Interactions", () =>
            {
                ...
                return new WorldInteraction[]
                {
                    new WorldInteraction()
                    {
                            ...
                            {
                                var be = api.World.BlockAccessor.GetBlockEntity(bs.Position) as BERackHorizontalWood2x3;
        ...
        public override void GetHeldItemInfo(ItemSlot inSlot, StringBuilder dsc, IWorldAccessor world, bool withDebugInfo)
        {
            ...
            dsc.AppendLine(Lang.Get("moreinventorys:block-rackhorizontalwood2x3-desc-storage"));
            dsc.AppendLine();
        ...
        {
            if (world.BlockAccessor.GetBlockEntity(blockSel.Position) is BERackHorizontalWood2x3 be)
            {
        ...
        public override bool TryPlaceBlock(IWorldAccessor world, IPlayer byPlayer, ItemStack itemstack, BlockSelection blockSel, ref string failureCode)
        {
            ...
            if (be is BERackHorizontalWood2x3 rackBe)
            {
        ...
        public override void OnBlockRemoved(IWorldAccessor world, BlockPos pos)
        {
            ...
            var be = world.BlockAccessor.GetBlockEntity(pos) as BERackHorizontalWood2x3;
            if (be != null)
            {
