...
{
    public class WardRobeBlock : Block
    {
        ...
        public override void GetHeldItemInfo(ItemSlot inSlot, StringBuilder dsc, IWorldAccessor world, bool withDebugInfo)
        {
            ...
            dsc.AppendLine(Lang.Get("moreinventorys:block-wardrobe-desc-storage"));
            dsc.AppendLine(Lang.Get("moreinventorys:block-wardrobe-desc"));
        ...
        public override void OnBlockRemoved(IWorldAccessor world, BlockPos pos)
        {
            ...
            var be = world.BlockAccessor.GetBlockEntity(pos) as BEWardRobe;
            if (be != null)
            {
        ...
        {
            BEWardRobe be = world.BlockAccessor.GetBlockEntity(blockSel.Position) as BEWardRobe;
