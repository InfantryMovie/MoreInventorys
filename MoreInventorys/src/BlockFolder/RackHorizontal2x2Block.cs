...
{
    internal class RackHorizontal2x2Block : Block
    {
        ...
        public override void OnLoaded(ICoreAPI api)
        {
            ...
            interactions = ObjectCacheUtil.GetOrCreate(api, "rackhorizontal2x2Interactions", () =>
            {
                ...
                return new WorldInteraction[]
                {
                    new WorldInteraction()
                    {
                            ...
                            {
                                var be = api.World.BlockAccessor.GetBlockEntity(bs.Position) as BERackHorizontal2x2;
        ...
        public override void GetHeldItemInfo(ItemSlot inSlot, StringBuilder dsc, IWorldAccessor world, bool withDebugInfo)
        {
            ...
            dsc.AppendLine(Lang.Get("moreinventorys:block-rackhorizontal-desc-storage"));
            dsc.AppendLine();
        ...
        {
            if (world.BlockAccessor.GetBlockEntity(blockSel.Position) is BERackHorizontal2x2 be)
            {
        ...
        public override bool TryPlaceBlock(IWorldAccessor world, IPlayer byPlayer, ItemStack itemstack, BlockSelection blockSel, ref string failureCode)
        {
            ...
            if (world.BlockAccessor.GetBlockId(upperPart1) != 0 
                || world.BlockAccessor.GetBlockId(rightBlockpos) != 0 || world.BlockAccessor.GetBlockId(rightUp1) != 0) return false;
            ...
            if (be is BERackHorizontal2x2 rackBe)
            {
        ...
        public override void OnBlockRemoved(IWorldAccessor world, BlockPos pos)
        {
            ...
            var be = world.BlockAccessor.GetBlockEntity(pos) as BERackHorizontal2x2;
            if (be != null)
            {
