...
{
    internal class RackStick1x2Block : Block
    {
        ...
        public override void OnLoaded(ICoreAPI api)
        {
            ...
            interactions = ObjectCacheUtil.GetOrCreate(api, "rackStick1x2Interactions", () =>
            {
                ...
                return new WorldInteraction[]
                {
                    new WorldInteraction()
                    {
                            ...
                            {
                                var be = api.World.BlockAccessor.GetBlockEntity(bs.Position) as BERackStick1x2;
        ...
        {
            if (world.BlockAccessor.GetBlockEntity(blockSel.Position) is BERackStick1x2 be)
            {
        ...
        public override bool TryPlaceBlock(IWorldAccessor world, IPlayer byPlayer, ItemStack itemstack, BlockSelection blockSel, ref string failureCode)
        {
            ...
            if (be is BERackStick1x2 rackBe)
            {
        ...
        public override void OnBlockRemoved(IWorldAccessor world, BlockPos pos)
        {
            ...
            var be = world.BlockAccessor.GetBlockEntity(pos) as BERackStick1x2;
            if (be != null)
            {
