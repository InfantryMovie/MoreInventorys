...
{
    internal class BERackHorizontalWood2x2 : BERackBase
    {
        public override string GuiTitle { get; }
        string container3;
        string container4;

        public BERackHorizontalWood2x2() : base("rackhorizontalwood2x2-0", 2, 2, true, 4)
        {
            GuiTitle = Lang.Get("moreinventorys:block-rackhorizontalwood2x2-north");
        }
