...
namespace MoreInventorys.src.BlockEntityFolder
{
    internal class BERackHorizontalWood2x2 : BlockEntityDisplay
    {
        ...
        public override string InventoryClassName => "rackhorizontalwood2x2dynamic";

        GuiDialogDynamic storageDlg;

        public const int MAX_CONTAINER_BLOC_SLOTS = 4;
        public bool isOpened;
        public BERackHorizontalWood2x2()
        {
            inventory = new InventoryDynamic("rackhorizontalwood2x2-0", MAX_CONTAINER_BLOC_SLOTS, null);
