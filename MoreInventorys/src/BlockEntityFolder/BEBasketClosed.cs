...
{
    public class BEBasketClosed : BlockEntityDisplay
    {
        ...
        public BEBasketClosed()
        {
            inv = new InventoryGeneric(slotCount, "mibasketclosed-0", null);
        }
        ...
        public override void Initialize(ICoreAPI api)
        {
            ...
            if (api.Side == EnumAppSide.Client)
            {
                ...
                AssetLocation shapeLoc = new AssetLocation("moreinventorys:shapes/mibasketclosed.json");
                Shape shape = Shape.TryGet(capi, shapeLoc);
                if (shape == null) return;

                animUtil?.InitializeAnimator("mibasketclosed", shape, null, new Vec3f(0, block.Shape.rotateY, 0));
            }
        }
