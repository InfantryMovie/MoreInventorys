...
{
    internal class BERackVertical : BERackBase
    {
        public override string GuiTitle { get; }
        string container3;

        public BERackVertical() : base("rackverticalone-0", 1, 3, false, 3)
        {
            GuiTitle = Lang.Get("moreinventorys:block-rackverticalone-north");
        }
