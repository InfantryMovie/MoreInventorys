...
{
    internal class GuiTwentyFourSlots: GuiDialogBlockEntity
    {
        
        public GuiTwentyFourSlots(string dialogTitle, InventoryBase inventory, BlockPos blockEntityPos, ICoreClientAPI capi)
